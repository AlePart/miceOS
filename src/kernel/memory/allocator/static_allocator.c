...
void static_allocator_init(uint32_t base_address)
{
    ...
    base_dictionary[0].addr_end= ((uint8_t*)base_address) + STATIC_DICTIONARY_ELEMENTS*sizeof(STATIC_ALLOC_DICTIONARY_ELEMENT);
...
{
    STATIC_ALLOC_DICTIONARY_ELEMENT* el = &base_dictionary[1];
